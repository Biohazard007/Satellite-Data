...
folium.CircleMarker(location=[27.505990145214593, 83.4163982296154],
                    radius=100,
                    popup='Lansat Image location',
                    color='#00008b',
                    fill=True,
                    fill_color='#00008b').add_to(m)

folium.CircleMarker(location=[27.97959051141473, 83.5804099189001],
                    radius=100,
                    popup='Lansat Image location',
                    color='#006400',
                    fill=True,
